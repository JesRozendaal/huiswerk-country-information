...
})({"foQ6C":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "acfacf659d14ece1";
"use strict";
...
},{}],"az1Pc":[function(require,module,exports) {
...
function getLanguages(languages) {
    if (languages.length === 1) return `They speak ${languages[0].name}.`;
    else if (languages.length === 2) return `They speak ${languages[0].name} and ${languages[1].name}.`;
    else if (languages.length === 3) return `They speak ${languages[0].name}, ${languages[1].name} and ${languages[2].name}.`;
    else if (languages.length === 4) return `They speak ${languages[0].name}, ${languages[1].name}, ${languages[2].name} and ${languages[3].name}.`;
...
},{}]},["foQ6C","az1Pc"], "az1Pc", "parcelRequirecb08")

//# sourceMappingURL=search.9d14ece1.js.map
